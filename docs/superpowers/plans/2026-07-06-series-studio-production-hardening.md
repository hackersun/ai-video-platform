...
```bash
rg -n "seedance-2-contract-checklist|experimental|Agent Plan 通道保持单参考|@图\{index\}|shot\.audio_url|Access date|Evidence artifact/test" docs/seedance-2-contract-checklist.md docs/continuous-anime-production-implementation-plan-v2.md
```
