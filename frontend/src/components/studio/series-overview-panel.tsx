...
import { AlertTriangle, CheckCircle2, Film, Gauge } from 'lucide-react';
...
export function SeriesOverviewPanel({
  ...
  return (
    <Card className="border-cyan-400/20 bg-cyan-500/[0.08]">
      <CardContent className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.9fr)_minmax(0,0.8fr)] lg:items-center">
