      ...
      <div className="max-w-5xl space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-white/60">调整界面密度、动效和强调色，偏好会在刷新后自动恢复。</p>
          </div>
        </div>
        ...
        <Card className="overflow-hidden border-white/10 bg-white/5">
          <CardContent className="grid grid-cols-1 gap-0 p-0 lg:grid-cols-[1fr_1.1fr]">
            <div className="space-y-4 p-6">
              ...
              <h2 className="text-2xl font-semibold text-white">专注创作的深色工作台</h2>
              <p className="text-sm leading-6 text-white/55">
                当前产品主视觉以深色为基础，避免新增浅色主题导致未覆盖页面出现对比度问题。本轮只提供安全的强调色、布局密度和动效偏好。
              </p>
        ...
        <Card className="border-white/10 bg-white/5">
          <CardContent className="flex items-start gap-3 p-4 text-sm text-white/60">
            <Moon className="mt-0.5 h-5 w-5 shrink-0 text-white/50" />
            <div>
              <p className="font-medium text-white">为什么暂不开放浅色模式</p>
              <p className="mt-1">
                现有页面和组件大量围绕深色背景、半透明卡片和媒体预览设计。为避免影响功能页面可读性，本轮只落地不会破坏现有页面的外观偏好。
              </p>
            </div>
