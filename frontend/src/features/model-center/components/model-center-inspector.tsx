...
const titles: Record<ModelCenterSection, string> = {
  overview: '全局配置', connections: '供应商账号', catalog: '模型详情', bindings: '默认模型',
